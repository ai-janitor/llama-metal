...
void ggml_compute_forward_irfft(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_fold(const struct ggml_compute_params * params, struct ggml_tensor * dst);
